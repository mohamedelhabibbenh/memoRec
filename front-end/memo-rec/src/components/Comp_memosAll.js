...
export default function Comp_memosAll(props) {
...
`;
  return (<Header>
    ...
    <div>
      <Link to='/' className="text-link" style={{ color: cols.orangy_red }}>My Memos</Link>
      <Link to='/my_favs' className="text-link" style={{ color: cols.dark_purple }} >My Favorites</Link>
      <Link to='/removed' className="text-link" style={{ color: cols.dark_purple }} >Removed</Link>
...
`;
const CreateNewMemo=styled.div`
...
`;
  ...
  return (<Content >
    <Header>
      <p style={{ color: cols.white }}>memoRec<span style={{ color: cols.black }}>/My Memos</span></p>
      <h2>My Memos</h2>
    </Header>
    <MemoListContainer>
      <CreateNewMemo onClick={()=>props.methods.fn_openCreateMemo()}><p>+</p></CreateNewMemo>
...
const Cmp_memo = (props) => {
  ...
  return (<Container>
    <Buttons>
      ...
      <div onClick={() => fn_view({id ,title ,content ,favorite ,color ,removed })}><img src={icons.ic_view} alt="" /></div>
      <div onClick={() => fn_edit({id ,title ,content ,favorite ,color})}><img src={icons.ic_edit} alt="" /></div>
      <div onClick={() => fn_remove(id)}><img src={icons.ic_remove} alt="" /></div>
    ...
    <Buttons>
      ...
      {
        !favorite ? <div onClick={() => fn_addToFavorites(id)}><img src={icons.ic_fav} alt="" /></div>
          : <div onClick={() => fn_addToFavorites(id)}><img src={icons.ic_fav_fill} alt="" /></div>
      }
    </Buttons>
  </Container>)
}
